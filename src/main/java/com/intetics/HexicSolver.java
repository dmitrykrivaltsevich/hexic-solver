...
public class HexicSolver {
    ...
    private final static int[][] ROTATION_POINTS = new int[][] {
            {  0, 10,  5}, {  0,  6, 10}, {  1, 11,  6},
            {  5, 10, 15}, {  6, 16, 10}, {  6, 11, 16},
            { 10, 20, 15}, { 10, 16, 20}, { 11, 21, 16},
            { 15, 20, 25}, { 16, 26, 20}, { 16, 21, 26},
            { 20, 30, 25}, { 20, 26, 30}, { 21, 31, 26},
            { 25, 30, 35}, { 26, 36, 30}, { 26, 31, 36},
            { 30, 40, 35}, { 30, 36, 40}, { 31, 41, 36},
            { 35, 40, 45}, { 36, 46, 40}, { 36, 41, 46},
            { 40, 50, 45}, { 40, 46, 50}, { 41, 51, 46},
            { 45, 50, 55}, { 46, 56, 50}, { 46, 51, 56},
            { 50, 60, 55}, { 50, 56, 60}, { 51, 61, 56},
            { 55, 60, 65}, { 56, 66, 60}, { 56, 61, 66},
            { 60, 70, 65}, { 60, 66, 70}, { 61, 71, 66},
            { 65, 70, 75}, { 66, 76, 70}, { 66, 71, 76},
            { 70, 80, 75}, { 70, 76, 80}, { 71, 81, 76},
    };
